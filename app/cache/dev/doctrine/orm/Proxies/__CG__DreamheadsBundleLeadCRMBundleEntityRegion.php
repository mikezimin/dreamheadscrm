 ...
 */
class Region extends \Dreamheads\Bundle\LeadCRMBundle\Entity\Region implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::addPhonePrefixe($phonePrefixes);
    }

    public function removePhonePrefixe(\Dreamheads\Bundle\LeadCRMBundle\Entity\PhonePrefix $phonePrefixes)
    {
        $this->__load();
        return parent::removePhonePrefixe($phonePrefixes);
    }

    public function getPhonePrefixes()
    {
        $this->__load();
        return parent::getPhonePrefixes();
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'id', 'name', 'phonePrefixes', 'leads');
    }
